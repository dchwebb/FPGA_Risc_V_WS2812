...
src/bsp/driver/riscv_mc/%.o: ../src/bsp/driver/riscv_mc/%.S
	...
	riscv-none-embed-gcc -march=rv32ic -mabi=ilp32 -msmall-data-limit=8 -mno-save-restore -O0 -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections  -g3 -x assembler-with-cpp -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
...
src/bsp/driver/riscv_mc/%.o: ../src/bsp/driver/riscv_mc/%.c
	...
	riscv-none-embed-gcc -march=rv32ic -mabi=ilp32 -msmall-data-limit=8 -mno-save-restore -O0 -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections  -g3 -DLSCC_STDIO_UART_APB -I"D:\docs\FPGA\SOC_IP\WS812_firmware/src/bsp" -I"D:\docs\FPGA\SOC_IP\WS812_firmware/src/bsp/driver" -I"D:\docs\FPGA\SOC_IP\WS812_firmware/src/bsp/driver/gpio" -I"D:\docs\FPGA\SOC_IP\WS812_firmware/src/bsp/driver/riscv_mc" -I"D:\docs\FPGA\SOC_IP\WS812_firmware/src/bsp/driver/uart" -std=gnu11 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
